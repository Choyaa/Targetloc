...
import argparse
from lib.transform import qvec2rotmat, rotmat2qvec, compute_pixel_focal, get_CRS

def write_to_line(information, GROUPLENGTH, i, SRT_name, fps, sensorH, sensorW, focal_len, width, height, video_type, exp_place):
    """
...
def main_bak():
    ...
    parser.add_argument("--input_SRT_path", default="/home/ubuntu/Documents/code/github/Render2loc/datasets/demo4/raw/")
    # parser.add_argument("--output_intrinsic_path", default="D:/SomeCodes/SensLoc/datasets/jinxia/query/txt/queries")
    parser.add_argument("--output_path", default="/home/ubuntu/Documents/code/github/Render2loc/datasets/demo4/raw")
...
def main(config):
    ...
    # intrinsic = [args.imgWidth, args.imgHeight, args.sensorW, args.sensorH, args.imgWidth//2, args.imgHeight//2, args.focal_length]
    input_SRT_path = config["input_path"]
